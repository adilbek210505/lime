...
const AddProduct = () => {
    const [image, setImage] = useState<string | null>(null); // Уточняем тип image
    ...
    return (
        <div className=" add-pic">
            <div className="click-icon">
                <NavLink to="/add-list"> <svg width="30" height="20" viewBox="0 0 30 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1.47919 8.83458L1.48066 8.83305L10.037 0.468413C10.678 -0.158211 11.7148 -0.155879 12.3529 0.473882C12.9909 1.10356 12.9884 2.12204 12.3474 2.74874L6.60265 8.36463L28.0344 8.36463C28.9388 8.36463 29.6719 9.08479 29.6719 9.97322C29.6719 10.8616 28.9388 11.5818 28.0344 11.5818L6.60273 11.5818L12.3473 17.1977C12.9883 17.8244 12.9908 18.8429 12.3528 19.4725C11.7147 20.1024 10.6779 20.1046 10.0369 19.478L1.48058 11.1134L1.47911 11.1119C0.837775 10.4831 0.83982 9.46128 1.47919 8.83458Z" fill="black"/>
                </svg>
                </NavLink>
            </div>
            <div className="photo-both" >
                <div className="photo">
                    <main>
                        <form onClick={() => {
                            ...
                            />
                            {image ? (
                                <img src={image} width="268px" height="269px" alt={fileName} />
                            ) : (
                ...
                <div className=" add-text ">
                    <div className="inputs ">
                        ...
                        <input type="text" placeholder=" Product description..." className="input2"/>
                    </div>
                   <NavLink to="/add-list">  <button ><h4>Save</h4></button></NavLink>
                </div>
            </div>
        </div>
    );
